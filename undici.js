...
class UndiciInstrumentation extends instrumentation_1.InstrumentationBase {
    constructor(config) {
        super('@opentelemetry/instrumentation-undici', version_1.VERSION, config);
    ...
    onDone({ request, response }) {
        ...
        (0, instrumentation_1.safeExecuteInTheMiddle)(() => { var _a; return (_a = config.applyCustomAttributesOnSpan) === null || _a === void 0 ? void 0 : _a.call(config, span, request, response); }, e => e && this._diag.error('caught applyCustomAttributesOnSpan error: ', e), true);
        // End the span
        span.end();
